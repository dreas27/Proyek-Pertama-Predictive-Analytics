# -*- coding: utf-8 -*-
"""Submission Dicoding - Predictive Analytics.ipynb
...
- Terdapat 5 kolom numerik dengan tipe data int64, yaitu: housing_median_age,	total_rooms,vpopulation,	households, dan	median_house_value. Kolom median_house_value merupakan target fitur kita.
"""
...
Karena terdapat 207 data null maka kita perlu melakukan imputasi dengan mengganti nilai null dengan nilai mean
"""
...
"""Dari histogram "median_house_value", kita bisa memperoleh beberapa informasi, antara lain:
- Peningkatan harga median rumah sebanding dengan penurunan jumlah sampel. Hal ini dapat kita lihat jelas dari histogram "median_house_value" yang grafiknya mengalami penurunan seiring dengan semakin banyaknya jumlah sampel (sumbu x).
- Rentang harga diamonds cukup tinggi yaitu dari skala ratusan dolar Amerika hingga sekitar 480000.
...
Pada tahap ini, kita akan mengecek rata-rata "median_house_value" terhadap masing-masing fitur untuk mengetahui pengaruh fitur kategori terhadap "median_house_value".
...
"""Dengan mengamati rata-rata 'median_house_value' relatif terhadap fitur kategori di atas, kita memperoleh *insight* sebagai berikut:
...
"""Fungsi pairplot dari library seaborn menunjukkan relasi pasangan dalam dataset. Dari grafik, kita dapat melihat plot relasi masing-masing fitur numerik pada dataset. Pada pola sebaran data grafik pairplot sebelumnya, terlihat bahwa 'median_income' memiliki korelasi dengan fitur 'median_house_value'. Sedangkan kedua fitur lainnya  terlihat memiliki korelasi yang lemah karena sebarannya tidak membentuk pola
...
"""Jika kita amati, fitur 'median_income' memiliki skor korelasi yang cukup besar (0.63) dengan fitur target 'median_house_value'. Artinya, fitur 'median_house_value' berkorelasi cukup tinggi dengan keempat fitur tersebut. Sementara itu, fitur lainnya memiliki korelasi negatif sehingga, fitur tersebut dapat di-drop."""
...
Untuk melakukan proses encoding fitur kategori, salah satu teknik yang umum dilakukan adalah teknik one-hot-encoding.  Mari kita lakukan proses encoding ini dengan fitur get_dummies.
"""
...
"""Selanjutnya, kita reduksi 3 fitur ini dengan PCA
...
"""Setelah menerapkan class PCA, kita bisa mengecek proporsi informasi dari ketiga komponen PCs tadi."""
...
Berdasarkan hasil ini, kita akan mereduksi fitur (dimensi) dan hanya mempertahankan PC (komponen) pertama saja. PC pertama ini akan menjadi fitur 'house properties' menggantikan ketiga fitur lainnya ('total_rooms',	'total_bedrooms',	'households'). Kita beri nama fitur ini 'house properties'
"""
...
Pada model ini, kita akan menggunakan proporsi pembagian sebesar 90:10 dengan fungsi train_test_split dari sklearn.
"""
...
Untuk fitur numerik, kita tidak melakukan proses transformasi dengan one-hot-encoding seperti pada fitur kategori. Kita menggunakan StandarScaler.
...
"""Seperti yang telah disebutkan sebelumnya, proses standarisasi mengubah nilai rata-rata (mean) menjadi 0 dan nilai standar deviasi menjadi 1. Untuk itu kita perlu mengecek nilai mean dan standar deviasi pada setelah proses standarisasi."""
...
Pertama, kita akan bekerja dengan regresi linear. Regresi linear adalah teknik analisis data yang memprediksi nilai data yang tidak diketahui dengan menggunakan nilai data lain yang terkait dan diketahui.
"""
...
Sekarang, setelah model selesai dilatih dengan 4 algoritma, selanjutnya kita lihat performa model dengan menggunakan metrik evaluasi
"""
...
"""Sekarang, setelah model selesai dilatih, kita perlu melakukan proses scaling terhadap data uji. Hal ini harus dilakukan agar skala antara data latih dan data uji sama dan kita bisa melakukan evaluasi.
